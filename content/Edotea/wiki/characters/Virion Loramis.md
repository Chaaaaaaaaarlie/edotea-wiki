...
| Name | Virion Loramis |
| Rasse | Halbelf |
| Offizielle Funktion | *Stellvertretender* Schulleiter der [[Magische Akademie Lunovar]] |
| Tatsächliche Funktion | **Faktischer Schulleiter** der Akademie — alle wichtigen Entscheidungen gehen durch ihn |
| Forschungsschwerpunkt | **[[Risse]]** — leitet die akademie-eigene Forschung dazu |
| Abstammung | Aus einer der höheren Halbelfen-Familien Lunovars (erste Generation) |

## Hintergrund
Halbelf aus einem etwas höheren Haus Lunovars — dadurch halbwegs gut behandelt, *"damit er keine Schande für die Familie ist"*. Trotz Diskriminierung gegen Halbelfen schaffte er es durch eigene **Errungenschaften** zum tatsächlichen Schulleiter — wird aber aus politischen Gründen als "Stellvertreter" geführt, während der Elf [[Fohlen]] als Galleonsfigur firmiert.

## Bekannte Fakten ([[Session 12]])
