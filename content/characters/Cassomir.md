...
| Name | Cassomir |
| Rasse | Elf |
| Funktion | Oberste Gerichtsinstanz der **Hohen Familien** |
| Haarfarbe | Silber |
| Ausrüstung | Schwarze Lederrüstung, 3 Schwerter (1 an der Seite, 2 auf dem Rücken) |
| Auftreten | Sehr grimmig, fair, gefürchtet sogar von Adelsfamilien |
| Status | Kein Lunovar-Stadtbeamter — externe Autorität über die Adelsgeschlechter |
| Adjutant | Magier mit Stab (wirft Zone of Truth, fertigt Skizzen an) |

## Beschreibung

Silberhaariger Elf, stets in schwarzer Lederrüstung. Trägt auffällig drei Schwerter — eines an der Seite und zwei auf dem Rücken. Wirkt extrem einschüchternd und unnahbar, handelt aber nach eigenen Angaben nach dem Prinzip Fairness. Selbst die mächtigsten Adelsfamilien fürchten ihn.

Cassomir ist keine Lunovar-Stadtbehörde, sondern eine **eigenständige Gerichtsbarkeit** über die Hohen Familien — seine Zuständigkeit endet (und beginnt) dort, wo es um die Adelshäuser selbst geht.

Er trat die [[Session 15]]-Anhörung **selbst in die Zone of Truth ein** — ein Zeichen, dass er nach denselben Regeln spielt, die er anderen auferlegt.

## [[Session 15]] — Gerichtsanhörung (Zone of Truth)

Die Gruppe wurde nach der Kronenklaue-Eskalation aus [[Session 14]] vor Cassomir gebracht.

**Cassomir's Adjutant** (Magier mit Stab) wirft die **Zone of Truth**. Cassomir selbst betritt die Zone ebenfalls.

### Ergebnisse
- **[[Krone des Hohen Rates|Kronendiebstahl]] ([[Khirin]])**: 100 Gold Strafe. **[[Krone des Hohen Rates|Krone]] zurückgegeben** an Cassomirs Adjutant.
- **Mordvorwürfe** (Leichen im Akademie-Badezimmer): geklärt — [[Fohlen]] übernahm Verantwortung für das, was er wusste.
- **[[Elfaria Albis von Sylphid]]**: Informationen zurückgehalten → wird von Cassomir eigenständig verfolgt; die falschen Mordanklagen gegen die Gruppe wurden fallen gelassen.
- **Lady Günthers Pony**: offiziell freigesprochen — niemand hat Eigentumsanspruch erhoben.
- **Magolor-Illustration**: [[Berta]] zeigte ihre Illusion von [[Magolor]]; Cassomirs Adjutant fertigte eine Skizze an.
