...
![[Porzellan-Maske_Khirin.webp|500]]
...
- In [[Session 7]] erhält [[Khirin]] von [[Elliot]] dessen Familienring für weitere Nachforschungen zu den alten Laboren und Siegeln.
...
- **[[Session 12]]**:
  - Bestätigt: Wizard der **Evocation-Schule (Level 6)** mit **Sculpt Spells** (kann Verbündete aus eigenen AoEs aussparen).
  - Beauftragt bei [[Magilanikas Maven]] eine **Magiespeicher-Halskette** aus einem mitgebrachten Kristall (95 G, 2 Tage) — [[Fohlen]] warnt später vor mangelhafter Qualität.
  - Identifiziert [[Hrímnir]]s gestohlenen [[Staff of Fire]] als nahezu defekt.
  - Trägt **Harlekin-Maske** in der Arena.
  - Castet **Fireball** in der Mind-Flayer-Arena (30 Schaden) mit Sculpt-Spells-Schonung der Gruppe.
  - Nimmt eine Mind-Flayer-**Armschiene** als Memorabilium.
  - Bittet [[Fohlen]] um Triangulation seiner [[Elliot|Elliot-]]Kristallkugel → Standort: **[[Carbus]]** (in einer Höhle, gelagert).
