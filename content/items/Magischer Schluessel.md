---
type: item
title: "Magischer Schlüssel (Schlüssel des Nichts)"
item_type: artefakt
tags:
  - item
  - artefakt
...
# Magischer Schlüssel (Schlüssel des Nichts)

## Übersicht
Fancy aussehender Schlüssel, den [[Berta]] in [[Session 12]] aus den Händen von [[das Nichts]] erhält — Bezahlung des Nichts-Anteils ihrer Abmachung.
...
> [!warning] Spoiler-Risiko bei mechanischen Details.

1. Funktioniert *jedes* Schloss — oder nur magisch-bedeutsame Schlösser?
2. Ist der Schlüssel mit einer **Beschwörung des Nichts** verbunden (versehentlicher Ruf bei Aktivierung)?
3. Hat das Aufschließen Konsequenzen, die das Nichts nicht erwähnt hat?
