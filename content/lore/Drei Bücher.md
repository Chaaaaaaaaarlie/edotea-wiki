...
- **Beschaffenheit** (Tagebuch V): identischer dunkler Einband aus unbekanntem, wärmespeicherndem "Leder"; makellose Seiten ohne Alters- oder Gebrauchsspuren; **vollkommen identische Schrift ohne kleinste Variation** zwischen den drei Exemplaren — Wilhelm: *"Als wären sie nicht geschrieben worden. Sondern entstanden."*
- **Auftauchen**: Wilhelms Buch lag eines Morgens auf seinem Tisch (Tagebuch III). Lysanthiriels und Borgrims Bücher erschienen erst, nachdem das Traumwesen sie nachts angesprochen hatte (Tagebuch V).
- Ein Traumwesen bot allen drei Forschern Hilfe an und verlangte dafür *"alles, was sie sind — Erinnerungen, Erfahrungen, alles, was sie noch erleben würden, Vergangenheit, Gegenwart und Zukunft."* Dieser Preis ist **wortgleich** mit [[Berta|Bertas]] Pakt mit [[das Nichts]] → Verdacht: identische Entität.
- **Plan des Königs** (Tagebuch VI) — die Bücher kombinieren, um das Wesen herbeizuzwingen und zu unterwerfen:
